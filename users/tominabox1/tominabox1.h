...
#define KC_LHUI  UG_HUEU
#define KC_LHUD  UG_HUED
#define KC_LSAI  UG_SATU
#define KC_LSAD  UG_SATD
#define KC_LVAI  UG_VALU
#define KC_LVAD  UG_VALD
#define KC_LMOD  UG_NEXT
